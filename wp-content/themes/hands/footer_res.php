							...
							<div class="widget clearfix">
								<div class="row clearfix">
									<div class="col-md-12 bottommargin-sm clearfix" style="color:#FFF; margin-bottom:15px">
										...
										<p style="text-align:center">Hands is a social artificial intelligence that helps everyone with conversational user experience. </p>
			...
			<div id="copyrights" class="notoppadding">
				...
				<div class="container clearfix">
					...
					<div  id="footer_copyright" class="col_half footer-text">
						Copyrights &copy; 2017 All Rights Reserved by Everythink Ink.<br>

...
function single_member_content( $content ) {
    ...
    if ( is_single() && get_post_type() == 'team_member' &&
        ...
        $team_member_title = get_field('team_member_title', $post->ID);

            ?>
        <br>
        <div id="sc_our_team">

            <div class="sc_team_member canpalte">
            ...
            <div class="team team-list clearfix">
                                ...
                                <div class="team-desc">
                                    <div class="team-title"><h4><?php echo $title?></h4><span><?php echo $team_member_title?></span></div>
